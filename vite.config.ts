  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        description: "FurniShop is a furniture store offering a wide range of high-quality products to enhance your home, including sofas, tables, chairs, and cabinets with modern and elegant designs.",
        theme_color: "#286F6C",
        icons: [
          {
